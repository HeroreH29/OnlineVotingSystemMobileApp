...
public class ViceChairpersonAdapter extends FirestoreRecyclerAdapter<VoterCandidateItem, ViceChairpersonAdapter.ViewHolder> {
    private OnItemClickListener listener;

    public ViceChairpersonAdapter(@NonNull FirestoreRecyclerOptions<VoterCandidateItem> options) {
        super(options);
    }
