...
public class HasVotedAdapter extends FirestoreRecyclerAdapter<AdminVoterItem, HasVotedAdapter.ViewHolder> {
    private OnItemClickListener listener;

    public HasVotedAdapter(@NonNull FirestoreRecyclerOptions<AdminVoterItem> options) {
        super(options);
    }
