...
public class SecondYearAdapter extends FirestoreRecyclerAdapter<VoterCandidateItem, SecondYearAdapter.ViewHolder> {
    private OnItemClickListener listener;

    public SecondYearAdapter(@NonNull FirestoreRecyclerOptions<VoterCandidateItem> options) {
        super(options);
    }
