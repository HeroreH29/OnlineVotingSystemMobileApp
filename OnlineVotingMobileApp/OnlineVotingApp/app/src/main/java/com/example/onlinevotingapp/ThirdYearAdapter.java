...
public class ThirdYearAdapter extends FirestoreRecyclerAdapter<VoterCandidateItem, ThirdYearAdapter.ViewHolder> {
    private OnItemClickListener listener;

    public ThirdYearAdapter(@NonNull FirestoreRecyclerOptions<VoterCandidateItem> options) {
        super(options);
    }
