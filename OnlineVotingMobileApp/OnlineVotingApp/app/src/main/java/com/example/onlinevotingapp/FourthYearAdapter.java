...
public class FourthYearAdapter extends FirestoreRecyclerAdapter<VoterCandidateItem, FourthYearAdapter.ViewHolder> {
    private OnItemClickListener listener;

    public FourthYearAdapter(@NonNull FirestoreRecyclerOptions<VoterCandidateItem> options) {
        super(options);
    }
