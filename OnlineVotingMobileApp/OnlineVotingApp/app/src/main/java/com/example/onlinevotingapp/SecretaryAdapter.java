...
public class SecretaryAdapter extends FirestoreRecyclerAdapter<VoterCandidateItem, SecretaryAdapter.ViewHolder> {
    private OnItemClickListener listener;

    public SecretaryAdapter(@NonNull FirestoreRecyclerOptions<VoterCandidateItem> options) {
        super(options);
    }
