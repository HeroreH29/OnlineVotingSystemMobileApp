...
public class AuditorAdapter extends FirestoreRecyclerAdapter<VoterCandidateItem, AuditorAdapter.ViewHolder> {
    private OnItemClickListener listener;

    public AuditorAdapter(@NonNull FirestoreRecyclerOptions<VoterCandidateItem> options) {
        super(options);
    }
