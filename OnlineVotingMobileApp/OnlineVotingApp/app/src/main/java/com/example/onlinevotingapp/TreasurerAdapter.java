...
public class TreasurerAdapter extends FirestoreRecyclerAdapter<VoterCandidateItem, TreasurerAdapter.ViewHolder> {
    private OnItemClickListener listener;

    public TreasurerAdapter(@NonNull FirestoreRecyclerOptions<VoterCandidateItem> options) {
        super(options);
    }
