...
public class ChairpersonAdapter extends FirestoreRecyclerAdapter<VoterCandidateItem, ChairpersonAdapter.ViewHolder> {
    private OnItemClickListener listener;

    public ChairpersonAdapter(@NonNull FirestoreRecyclerOptions<VoterCandidateItem> options) {
        super(options);
    }
